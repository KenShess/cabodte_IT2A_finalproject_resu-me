...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      ...
      <p>I'm <span class="typed" data-typed-items="Developer, Entrepreneur, Photographer, Singer"></span></p>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="assets/img/ProfilePic.jpg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <h3 class="resume-title">Education</h3>
                <div class="resume-item">
                  <h4>Elementary</h4>
                  <h5>2009 - 2015</h5>
                  <p><em>Sampaloc Site II Elementary School</em></p>
                </div>
                <div class="resume-item">
                  <h4>High School</h4>
                  <h5>2015 - 2018</h5>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <h3 class="resume-title">Awards and Achievements</h3>
                ...
                <div class="resume-item">
                  <h4>Best in Film Director/Editor</h4>
                  <h5>Grade 12</h5>
                  <p><em>Marinduque National High School</em></p>
                </div>
          </div>
          ...
          <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item" data-aos="fade-up">
                    ...
                    <img src="assets/img/testimonials/1althea.jpg" class="testimonial-img" alt="">
                    <h3>Althea Lacena</h3>
                    <h4>Ceo &amp; Founder</h4>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <img src="assets/img/testimonials/1gemma.jpg" class="testimonial-img" alt="">
                    <h3>Gemma Laderas</h3>
                    <h4>Designer</h4>
                  </div>
                </div><!-- End testimonial item -->
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        Copyright &copy; 2022 <strong><span>Resu'me</span></strong>
      </div>
      <div class="credits">
